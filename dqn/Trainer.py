...
def run_n_games(N, qapp, env, run_name='', params_iter=None, loading_file=None):
    ...
    for n in range(N):
        ...
        total_reward, mean_loss = play_game(
            qapp, env, TrainNet, TargetNet, epsilon)
